 ...
 */
package com.utstar.cli.commands;
...
public class GreetCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(GreetCliTestCommand.class);
    protected final GreetCliCommands service;

    public GreetCliTestCommand(final GreetCliCommands service) {
